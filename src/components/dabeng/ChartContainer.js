...
const _jsonDigger = _interopRequireDefault(require("json-digger"))

const _html2canvas = _interopRequireDefault(require("html2canvas"))

const _jspdf = _interopRequireDefault(require("jspdf"))
...
const ChartContainer = (0, _react.forwardRef)(function (_ref, ref) {
  ...
  const exportPDF = function exportPDF(canvas, exportFilename) {
